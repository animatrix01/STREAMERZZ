...
const KeyFeatures = () => {
  ...
  const featuresVariants = {
    ...
    // Assuming a 'hidden' state is defined for the initial position,
    // e.g., hidden: { opacity: 0, y: 50 }
  };
  ...
  const containerVariants = {
    ...
    visible: {
      ...
      transition: {
        staggerChildren: 0.2,
        when: "beforeChildren" // This staggers the animation of the child feature cards
      },
    },
  };
  ...
  return (
    <section>
      <div className="max-w-7xl mx-auto px-4 mt-20">
        {/* Section Title and Description (from the first image) */}
        ...
        {/* Feature List (from the second image) */}
